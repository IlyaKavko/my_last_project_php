...
class LiraxCore implements iLiraxCore
{
    ...
    {
        $LiraxCoreStructModel = $this->LiraxCoreSchema->getUserPhoneSchema();
    ...
    {
        $data = $this->getLiraxAdditionallySettings()->getSettingsStruct()->getNumber_of_call_attempts();;
    ...
    {
        $this->liraxAdditionallySettings = $settings;
    }

    function getLiraxAdditionallySettings(): iLiraxAdditionallySettings
    {
        if (isset($this->liraxAdditionallySettings)) return $this->liraxAdditionallySettings;
        return Factory::getLiraxAdditionallySettings();
