...
");
    ...
    {
        Factory::Log('str', "https://smart-dev.pragma.by/api/own/autocall/pragma/modules/core$filename");
        return exec('curl  https://smart-dev.pragma.by/api/own/autocall/pragma/modules/core' . $filename . ' > /dev/null &');
    }
