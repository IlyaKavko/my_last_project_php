...
class LiraxSettingsStruct implements iLiraxSettingsStruct
{
    ...
    function getTargetNumber(): int|null
    {
    ...
    {
    	$pragma_id = Factory::getPragmaAccountId();
        if ($pragma_id === 187)
        {
        	return 890;
        }
    ...
    function getUseLead(): string
    {
        return $this->use_lead;
    }
    ...
    #[Pure] function getArrayToSave(): array
    {
        ...
        $result['use_lead'] = $this->getUseLead();
