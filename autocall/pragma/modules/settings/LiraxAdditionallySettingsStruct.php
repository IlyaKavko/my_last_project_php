...
class LiraxAdditionallySettingsStruct implements iLiraxAdditionallySettingsStruct
{
    ...
    function setArrayUseLeadPipeline(array $array_pipeline): void
    {
        $this->ArrayUseLeadPipeline = $array_pipeline;
    }

    function getArrayUseLeadPipeline(): array
    {
        return $this->ArrayUseLeadPipeline;
    }
}