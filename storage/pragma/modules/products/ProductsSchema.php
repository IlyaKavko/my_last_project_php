...
class ProductsSchema extends PragmaStoreDB {
	...
	protected function deleteValuesOfSpecifications(int $product_id): bool {
        $specifications_value = $this->getSpecificationValueSchema();
        $sql = "DELETE FROM $specifications_value 
                WHERE `product_id` = $product_id";
		return self::execute($sql);
	}

	protected function deleteValuesOfDescriptions(int $product_id): bool {
        $descriptions_value = $this->getProductDescriptionSchema();
        $sql = "DELETE FROM $descriptions_value 
                WHERE `product_id` = $product_id";
		return self::execute($sql);
	}

	protected function deleteFromDbValuesOfTechCards(int $product_id): bool {
        $tech_value = $this->getTechnologicalCardProductSchema();
        $sql = "DELETE FROM $tech_value 
                WHERE `product_id` = $product_id";
		return self::execute($sql);
	}
