...
use Storage\Test\ProductsCreator;
use Storage\Test\StoresCreator;
...
class CategoriesToStoresTest extends \PHPUnit\Framework\TestCase {
    ...
    function testGetStoresForCategory(): void {
		...
		$category1 = self::createUniqueCategory();
		$category2 = self::createUniqueCategory();
	...
	function testGetCategoriesIdInStore(): void {
		$categoriesToStores = self::categoriesToStores();
		$category1 = self::getUniqueCategory();
		$category2 = self::getUniqueCategory();
		$category3 = self::getUniqueCategory();
...
//		$this->expectException(\Exception::class);
	...
	function testDeleteLink(): void {
        ...
        $category1 = self::createUniqueCategory();
        $categoriesToStores->saveCategoryLinks($category1->getCategoryId(), [$store1->getStoreId(),$store2->getStoreId(),$store3->getStoreId()]);

        $product1_1 = self::createUniqueProduct($products, $category1);
        $this->checkStoresIdForProduct($categoriesToStores, $product1_1->getProductId(), [$store1->getStoreId(),$store2->getStoreId(),$store3->getStoreId()]);

        $categoriesToStores->deleteLink($category1->getCategoryId(), $store2->getStoreId());
        $this->checkStoresIdForProduct($categoriesToStores, $product1_1->getProductId(), [$store1->getStoreId(),$store3->getStoreId()]);

        $categoriesToStores->deleteLink($category1->getCategoryId(), $store1->getStoreId());
        $this->checkStoresIdForProduct($categoriesToStores, $product1_1->getProductId(), [$store3->getStoreId()]);

        $categoriesToStores->deleteLink($category1->getCategoryId(), $store3->getStoreId());
        $this->checkStoresIdForProduct($categoriesToStores, $product1_1->getProductId(), []);
    }
...
//    }
	...
	static function createUniqueCategory(): iCategory {
